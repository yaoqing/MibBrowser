// PageUdpTable.cpp : implementation file
//
...
/////////////////////////////////////////////////////////////////////////////
// CPageUdpTable
IMPLEMENT_DYNCREATE(CPageUdpTable, CWnd)

CPageUdpTable::CPageUdpTable()
{
	font = new CFont();
...
BEGIN_MESSAGE_MAP(CPageUdpTable, CWnd)
	//{{AFX_MSG_MAP(CPageUdpTable)
	ON_WM_CREATE()
	ON_WM_ERASEBKGND()
...
/////////////////////////////////////////////////////////////////////////////
// CPageUdpTable message handlers

int CPageUdpTable::OnCreate(LPCREATESTRUCT lpCreateStruct) 
{
	...
	m_ctrProc.InsertColumn(0, LoadAsString(_T("property.page.udptable.localaddress.text"), _T("LocalAddress")), LVCFMT_RIGHT, 128);
	m_ctrProc.InsertColumn(1, LoadAsString(_T("property.page.udptable.localport.text"), _T("LocalPort")), LVCFMT_RIGHT, 64);
...
BOOL CPageUdpTable::OnEraseBkgnd(CDC* pDC) 
{
...
LRESULT CPageUdpTable::OnInitPage(WPARAM wParam, LPARAM lParam)
{
	...
	CStringEx strOID;
	strOID = _T("1.3.6.1.2.1.7.5.1.");
	CStringEx strRangeOID;
	strRangeOID = _T("1.3.6.1.2.1.7.5.1.");
	CStringEx strIndexOID;
	strIndexOID = _T("1.3.6.1.2.1.7.5.1.1.");
